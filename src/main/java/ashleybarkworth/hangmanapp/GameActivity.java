package ashleybarkworth.hangmanapp;
...
public class GameActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //start gameplay with specific level
        chooseDifficulty();
    ...
    private void playGame(int level){
        ...
        switch(level) {
            case 1:
                words = res.getStringArray(R.array.easy);
                break;
            case 2:
                words = res.getStringArray(R.array.medium);
                break;
            case 3:
                words = res.getStringArray(R.array.hard);
                break;
        }
                ...
                winBuild.setPositiveButton("Play Again",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                GameActivity.this.chooseDifficulty();
                            }});
    ...
    public void chooseDifficulty() {
        AlertDialog.Builder chooseBuild = new AlertDialog.Builder(this);
        chooseBuild.setTitle("Choose difficulty level");
        chooseBuild.setMessage("Choose the level of difficulty you wish to play at:");
        chooseBuild.setPositiveButton("HARD", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                playGame(3);
            }});
        chooseBuild.setNeutralButton("MEDIUM", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                playGame(2);
            }});
        chooseBuild.setNegativeButton("EASY", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                playGame(1);
            }});
        chooseBuild.show();
